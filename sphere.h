...
struct Sphere {
	...
	Sphere(const float sphRad_, const Vec &sphPos_, const Vec& sphEmi_, const Vec& sphCol_, const int sphMat_) : sphRad(sphRad_), sphPos(sphPos_), sphEmi(sphEmi_), sphCol(sphCol_), sphMat(sphMat_) {};
